...
POSSESSION_REPORT_COLUMNS: tuple[ReportColumn, ...] = (
    ...
    ReportColumn("driver_name", "Condutor", ReportColumnCategory.POSSESSION, ReportValueKind.TEXT, lambda c: c.possession.driver_name, ALL_REPORT_ROLES, SUMMARY_COMPLETE, ALL_MODES, ReportDataClassification.PERSONAL, True, "VISIBLE_BY_OPERATIONAL_SCOPE", 24),

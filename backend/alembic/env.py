...
from app.models import audit_log, data_import, document_signature, location_history, maintenance, possession, possession_trip, user, user_permission, vehicle  # noqa: F401
